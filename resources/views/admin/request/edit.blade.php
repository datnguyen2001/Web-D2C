            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="card mb-3">
                        <a href="#collapseExample3" class="btn bg-info text-white card-header">
                            <p class="d-flex align-items-center justify-content-between mb-0"><strong
                                    style="font-weight: unset">Nội dung bài đăng</strong><i
                                    class="fa fa-angle-down"></i></p>
                        </a>
                        <div class="card">
                            <div class="card-body mt-2">
                                <textarea name="describe" id="content" rows="10" disabled style="width: 100%">{!! $data->content !!}</textarea>
                            </div>
                        </div>
                    </div>
                        <div class="row mb-3 box_parameter_1">
                            <div class="col-2 d-flex align-items-center">
                                <p class="m-0 parameter_1">Thông tin liên hệ :</p>
                            </div>
                            <div class="col-10">
                        ...
                        <div class="row mb-3 box_parameter_2">
                            <div class="col-2 d-flex align-items-center">
                                <p class="m-0 parameter_2">Số lượng mua :</p>
                            </div>
                            <div class="col-10">
                        ...
                        <div class="row mb-3 box_parameter_3">
                            <div class="col-2 d-flex align-items-center">
                                <p class="m-0 parameter_3">Hạn ngày đăng :</p>
                            </div>
                            <div class="col-10">
                                <input class="form-control" name="date_end" disabled
                                       value="{{$data->date_end}}">
                            </div>
                        </div>
                        <div class="row mb-3 box_parameter_3">
                            <div class="col-2 d-flex align-items-center">
                                <p class="m-0 parameter_3">Khu vực ưu tiên :</p>
                            </div>
                            <div class="col-10">
                                <input class="form-control" name="scope" disabled
                    ...
                    <div class="card mb-3">
                        ...
                        <div class="row mb-4">
                            <label class="col-sm-2 col-form-label">Trạng thái yêu cầu: </label>
                    ...
                    <h8 class="card-title" style="color: #f26522">Thông tin Người đăng yêu cầu</h8>
                    <br>
                    <div class="row mb-3">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="d-flex justify-content-center mt-3">
                            @if($data->status == 0)
                            <a href="{{url('admin/request/status/1/'.$data->id)}}" type="reset" class="btn btn-success">Duyệt sản phẩm</a>
                                @else
                                <a href="{{url('admin/request/status/1/'.$data->id)}}" type="reset" class="btn btn-success">Khóa sản phẩm</a>
                            @endif
                        </div>
                </div>
            </div>
