                        ...
                        <div class="card-body">
                            ...
                            <div class="d-flex justify-content-end">
                                <form class="d-flex align-items-center w-50" method="get"
                                      action="{{route('admin.request.approved')}}">
                                    ...
                                    <a href="{{route('admin.request.approved')}}" class="btn btn-danger" style="margin-left: 15px">Hủy </a>
                                </form>
                            </div>
                                            ...
                                            @foreach($listData as $item)
                                                <div class="w-100 d-flex mb-5 pt-2 pb-2 content__product align-items-center">
                                                    ...
                                                    <div style="width: 10%" class="d-flex justify-content-center flex-column">
                                                        ...
                                                        <a href="{{url('admin/request/status/0/'.$item->id)}}" type="reset" class="btn btn-success">Khóa yêu cầu</a>
                                                    </div>
                                                </div>
                                            @endforeach
                                        </div>
