            ...
            <div class="bg-white p-4">
                <form action="{{route('admin.banner.store')}}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="row mt-3">
                        ...
                        <div class="col-8">
                            <input type="number" class="form-control" name="ordinal_number" value="1">
                        </div>
                    </div>
                    <div class="row mt-3">
                        ...
                        <div class="col-8">
                            <select name="location" class="form-control">
                                <option value="1">Banner home top left</option>
                                <option value="2">Banner home top right</option>
                                <option value="3">Banner home main center</option>
                            </select>
                        </div>
                    </div>
                    <div class="row mt-3">
